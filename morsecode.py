...
def is_validated_english_sentence(user_input):
    ...
    """
    # ===Modify codes below=============
    result = ''.join([s for s in user_input if not s in '.,!? '])
...
def is_validated_morse_code(user_input):
    ...
    user_code = [s for s in user_input.split() if not s in morse_values]
    return user_code == []
    # ==================================
...
def get_cleaned_english_sentence(raw_english_sentence):
    ...
    """
    # ===Modify codes below=============
    result = ''.join([s for s in raw_english_sentence if not s in ".,!?"])
    return result.strip()
    # ==================================
...
def decoding_character(morse_character):
    ...
    reverse_dict= dict(map(reversed, morse_code_dict.items()))
...
def encoding_sentence(english_sentence):
    ...
    for word in english_sentence.split():
        for s in word:
            result += encoding_character(s.upper()) + ' '
        result += ' '
    return result.strip()
    # ==================================
